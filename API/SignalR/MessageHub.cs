...
namespace DatingApp.SignalR
{
    public class MessageHub(IUnitOfWork unitOfWork, IMapper mapper, IHubContext<PresenceHub> presenceHub) : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if (recipient == null || sender == null || sender.UserName == null || recipient.UserName == null) throw new Exception("Cannot send message at this time");
        ...
        public async Task<Group> AddToGroup(string groupName)
        {
            ...
            return await unitOfWork.Complete() ? group : throw new HubException("Failed to join group");
        }
        private async Task<Group> RemoveFromMessageGroup()
        {
            ...
            if (connection != null && group != null)
            {
                ...
                return await unitOfWork.Complete() ? group : throw new HubException("Failed to remove group");
            }
